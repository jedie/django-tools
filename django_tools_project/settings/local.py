...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_PATH / 'django_tools-database.sqlite3'),
...
# Download map via geotiler in django_tools.gpx_tools.gpxpy2map.generate_map
MAP_DOWNLOAD = True
...
DEBUG_TOOLBAR_CONFIG['SHOW_TOOLBAR_CALLBACK'] = 'django_tools_project.middlewares.djdt_show'
