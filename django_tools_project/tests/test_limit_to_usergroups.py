...
from django_tools_project.django_tools_test_app.models import LimitToUsergroupsTestModel
...
class LimitToUsergroupsTest2(TestUserMixin, HtmlAssertionMixin, TestCase):
