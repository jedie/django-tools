...
MANAGE_DIR = Path(django_tools_project.__file__).parent
...
class CommandTestCase(TestUserMixin, DjangoCommandMixin, TestCase):
    ...
    def test_help(self):
        ...
        assert_text_snapshot(
            got=self.clean_manage_output(output),
            snapshot_name=f'test_commands_help_django{django.__version__}',
        )
    ...
    def test_nice_diffsettings(self):
        ...
        assert_text_snapshot(
            got=self.clean_manage_output(output),
            snapshot_name=f'test_commands_nice_diffsettings_django{django.__version__}',
        )
