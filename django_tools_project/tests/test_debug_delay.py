...
from django_tools_test_project.django_tools_test_app.views import delay_view
...
class SessionDelayTests(TestUserMixin, BaseTestCase):
    ...
    def test_delay(self):
        ...
        self.assertEqual(response.content, b'django_tools_test_project.django_tools_test_app.views.delay_view')
